...
const getModelDisplay = (
  model: string | { type?: string; model_name?: string } | undefined,
): string => {
    ...
    <div className="relative group w-[320px]">
      ...
      <div className="absolute inset-0 pointer-events-none z-50">
        <Handle
          ...
          id="pool-left-target"
          className="!w-3 !h-3 !bg-purple-500 !border-2 !border-background z-50 pointer-events-auto"
          style={{ top: "50%" }}
        />
        <Handle
          type="source"
          position={Position.Bottom}
          id="pool-bottom-source"
          className="!w-3 !h-3 !bg-blue-500 !border-2 !border-background z-50 pointer-events-auto"
        />
        <Handle
          type="source"
          position={Position.Right}
          id="right-history-source"
          className="!w-3 !h-3 !bg-pink-500 !border-2 !border-background z-50 pointer-events-auto"
          style={{ top: "50%" }}
        />
      </div>
    ...
    <div className="relative group w-[320px]">
      ...
      <div className="absolute inset-0 pointer-events-none z-50">
        ...
        <Handle
          ...
          position={Position.Left}
          id="left-tool-source"
          className="!w-3 !h-3 !bg-orange-500 !border-2 !border-background z-50 pointer-events-auto"
          style={{ top: 42 }}
        />
        <Handle
          type="source"
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="overflow-hidden flex-1">
            ...
            <p
              ...
              title={getModelDisplay(nodeData.model)}
            >
              {getModelDisplay(nodeData.model)}
            </p>
          </div>
        </div>
      </div>
...
export function ToolNode({ data }: NodeProps) {
  const nodeData = data as PearNodeData;
  const highlighted = !!nodeData.highlighted;
  const isCoreTool = nodeData.tool_type === "core";
